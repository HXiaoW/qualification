...
I then tried running from command line to first save the output notebook into a script, then running it to a txt output file, however, the output also did not correctly ran, and the running was terminated before any output. 